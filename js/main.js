...
;(function(window) {
	...
	CircleSlideshow.prototype._init = function() {
		...
		this.navLeftCtrl.innerHTML = '<svg width="100px" height="30px" viewBox="0 0 100 30"><polyline class="navbutton__line" fill="none" stroke="#12CDC9" stroke-width="10" points="70.821,3.795 90.232,26.205 25,26.205"/></svg>';
		...
		this.navRightCtrl.innerHTML = '<svg width="100px" height="30px" viewBox="0 0 100 30"><polyline class="navbutton__line" fill="none" stroke="#12CDC9" stroke-width="10" points="35.179,26.205 10.768,3.795 85,3.795"/></svg>';
